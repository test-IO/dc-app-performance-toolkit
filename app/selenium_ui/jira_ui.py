...
def test_1_selenium_accept_testio_bug(jira_webdriver, jira_datasets, jira_screen_shots):
     extension_ui.app_accept_testio_bug(jira_webdriver, jira_datasets)

def test_1_selenium_reject_testio_bug(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_reject_testio_bug(jira_webdriver, jira_datasets)
